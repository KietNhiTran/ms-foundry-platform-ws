...
.DESCRIPTION
    ...
    evaluations. The script:
      ...
      3. Assigns "Foundry User" role on the resource group
      4. Assigns "Cognitive Services OpenAI User" role on the resource group
      5. Assigns "Storage Blob Data Contributor" role on the resource group
      6. Prints all values needed for GitHub Actions secrets
